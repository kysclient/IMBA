...
export default function StoreClient() {
  ...
  const handleAddToCart = () => {
    if (!user) {
      showToast("장바구니는 로그인 후 이용할 수 있습니다.", "warning");
      router.push("/login");
      return;
    }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f8fafc]">
      {/* 1. Header Section */}
      <section className="bg-white pt-24 pb-12 sm:pt-32 sm:pb-16 lg:pt-40 lg:pb-20 text-center px-6 relative border-b border-gray-100 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-10%] right-[20%] w-[400px] h-[400px] rounded-full bg-[#ff6d00] opacity-[0.05] blur-[100px] animate-blob-drift" />
          <div className="absolute top-[5%] left-[10%] w-[350px] h-[350px] rounded-full bg-[#0b57d0] opacity-[0.06] blur-[90px] animate-blob-drift-reverse" />
          <div className="absolute bottom-[-20%] right-[40%] w-[450px] h-[450px] rounded-full bg-[#7c4dff] opacity-[0.04] blur-[110px] animate-blob-drift-slow" />
        </div>
              ...
              >
                <div className="relative w-full aspect-square bg-slate-100 overflow-hidden">
                  ...
                  <button
                    ...
                    className="absolute bottom-4 right-4 w-12 h-12 bg-white rounded-full flex items-center justify-center text-slate-400 shadow-md hover:text-[#0b57d0] hover:scale-110 transition-all z-10"
                  >

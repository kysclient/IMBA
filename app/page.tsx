  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full bg-white overflow-hidden pt-24 pb-20 lg:pt-36 lg:pb-32 flex flex-col items-center justify-center text-center">
        {/* Subtle Google colored background blur elements */}
        <div className="absolute top-[10%] left-[15%] w-72 h-72 bg-[#0b57d0] rounded-full blur-[120px] opacity-10 pointer-events-none"></div>
        <div className="absolute top-[30%] right-[15%] w-72 h-72 bg-[#ea4335] rounded-full blur-[120px] opacity-10 pointer-events-none"></div>
        <div className="absolute bottom-[20%] left-[40%] w-80 h-80 bg-[#fbbc04] rounded-full blur-[120px] opacity-10 pointer-events-none"></div>

        <div className="max-w-[1040px] mx-auto px-6 relative z-10 flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#f8fafc] border border-gray-200 text-sm font-medium text-[#1f1f1f] mb-8 shadow-sm hover:shadow transition-shadow">
            <span className="w-2 h-2 rounded-full bg-[#0b57d0] animate-pulse"></span>
            2026년도 신규 회원 모집 중
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-[5.5rem] font-normal tracking-tight text-[#1f1f1f] leading-[1.1] mb-8 max-w-[900px] font-sans">
            메디컬 뷰티 전문가의 <br />
            <span className="text-[#0b57d0]">새로운 스탠다드</span>
          </h1>

          <p className="text-lg sm:text-[1.3rem] text-[#444746] mb-12 max-w-[700px] leading-relaxed font-normal">
      ...
      <section className="py-24 bg-slate-900 overflow-hidden relative">
        <div className="absolute top-0 left-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1600508655079-05db4a52643a?q=80&w=2574&auto=format&fit=crop')] opacity-10 bg-cover bg-center mix-blend-overlay"></div>
